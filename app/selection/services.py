...
from models import TCadastre, TCommune, SelectionParcelle
...
def get_parcelles_by_filters(dep_code=None, commune_code_insee=None, section_val=None):
    query = db.session.query(TCadastre).select_from(TCadastre).join(TCommune, TCadastre.idcom == TCommune.code_insee_commune)\
...
def get_selected_parcelle_objects(session_id):
    return (
        ...
        .join(TCommune, TCadastre.idcom == TCommune.code_insee_commune)
