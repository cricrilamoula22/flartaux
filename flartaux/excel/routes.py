...
def export_excel():
    ...
    with db.engine.begin() as conn:
        ResultSet = conn.execute(text("""SELECT DISTINCT ddenom, t_cadastre.idprocpte, t_parceldem.par_idsuf, t_parceldem.par_nointerne FROM ((t_cadastre
LEFT JOIN t_parceldem
ON t_parceldem.par_idsuf = t_cadastre.idsuf)
LEFT JOIN t_proprietaires
ON t_proprietaires.idprocpte = t_cadastre.idprocpte)
WHERE t_parceldem.par_nointerne LIKE 'C22250045'
ORDER BY t_parceldem.par_idsuf ASC"""))
